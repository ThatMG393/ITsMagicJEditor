...
public class FolderViewHolder extends TreeViewHolder {
    ...
    public FolderViewHolder(View layout) {
        super(layout);
        this.layoutTextView = layout.findViewById(R.id.tree_directory_text);
    }
    ...
    public void bindTreeNode(TreeNode node) {
        ...
        // TODO: Implement icon login using switch statements and file name
    }
}
